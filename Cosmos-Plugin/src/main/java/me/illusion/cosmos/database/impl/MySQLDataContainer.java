...
public class MySQLDataContainer implements CosmosDataContainer {
    ...
    private MySQLConnectionProvider provider = null;
    ...
    public CompletableFuture<Boolean> enable(ConfigurationSection section) {
        provider = new MySQLConnectionProvider(section);
